...
const GoogleLoginModal = ({ onLogin }) => (
  <div className="modal-overlay google-modal-overlay">
    <div className="google-modal-card">
      ...
      <p className="google-modal-desc">To use Coldr, please sign in with your Google account.<br/>You can trust us, we use Google to securely send job applications on your behalf. Thanks</p>
